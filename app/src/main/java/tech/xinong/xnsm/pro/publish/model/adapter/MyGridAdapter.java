...
import tech.xinong.xnsm.views.MyImageView.OnMeasureListener;
...
public class MyGridAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			convertView=inflater.inflate(R.layout.item_select_photos_gridview, null);
		...
		Bitmap bitmap= ImageLoader.getInstance().loadImage(path, width,height, new ImageLoader.OnCallBackListener() {
