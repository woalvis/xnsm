...
public class ProductShowAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final SellerListingInfoDTO item = getItem(position);
        ...
        vh.setLayoutClickListener(new View.OnClickListener() {
            @Override
    ...
    public static class MyViewHolder{
        ...
        LinearLayout product_show_layout;
        public MyViewHolder(View convertView){
            ...
            product_show_layout = convertView.findViewById(R.id.product_show_layout);
        }

        public void setLayoutClickListener(View.OnClickListener listener){
            product_show_layout.setOnClickListener(listener);
        }

    }

    public void refresh(List<SellerListingInfoDTO> infos){
        this.infos = infos;
