...
/**
 * Created by xiao on 2017/2/20.
 */

public class MySquareTagImageView extends ImageView {
    ...
    private MySquareTagImageView.MyPoint startPoint;

    private MySquareTagImageView.MyPoint endPoint;
    ...
    public MySquareTagImageView(Context context) {
        this(context, null);
    }

    public MySquareTagImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MySquareTagImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mDensity = context.getResources().getDisplayMetrics().density;
        TypedArray a = context.obtainStyledAttributes(attrs, net.wujingchao.android.view.R.styleable.SimpleTagImageView,defStyleAttr,0);
        mTagOrientation = a.getInteger(net.wujingchao.android.view.R.styleable.SimpleTagImageView_simple_tag_orientation,0);
        mTagWidth = a.getDimensionPixelSize(net.wujingchao.android.view.R.styleable.SimpleTagImageView_simple_tag_width, dip2px(DEFAULT_TAG_WIDTH));
        mCornerDistance = a.getDimensionPixelSize(net.wujingchao.android.view.R.styleable.SimpleTagImageView_simple_corner_distance,dip2px(DEFAULT_CORNER_DISTANCE));
        mTagBackgroundColor = a.getColor(net.wujingchao.android.view.R.styleable.SimpleTagImageView_simple_tag_background_color,DEFAULT_TAG_BACKGROUND_COLOR);
        mTagText = a.getString(net.wujingchao.android.view.R.styleable.SimpleTagImageView_simple_tag_text);
        mTagTextSize = a.getDimensionPixelSize(net.wujingchao.android.view.R.styleable.SimpleTagImageView_simple_tag_textSize, dip2px(DEFAULT_TAG_TEXT_SIZE));
        mTagTextColor = a.getColor(net.wujingchao.android.view.R.styleable.SimpleTagImageView_simple_tag_textColor, DEFAULT_TAG_TEXT_COLOR);
        mTagEnable = a.getBoolean(net.wujingchao.android.view.R.styleable.SimpleTagImageView_simple_tag_enable,true);
        mRoundRadius = a.getDimensionPixelSize(net.wujingchao.android.view.R.styleable.SimpleTagImageView_simple_tag_round_radius,0);
        a.recycle();
        ...
        startPoint = new MySquareTagImageView.MyPoint();
        endPoint = new MySquareTagImageView.MyPoint();
