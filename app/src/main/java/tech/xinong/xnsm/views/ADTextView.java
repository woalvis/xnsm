...
public class ADTextView extends View {
    ...
    private void obtainStyledAttrs(AttributeSet attrs) {
        ...
        mFrontTextSize = (int) array.getDimension(R.styleable.ADTextView_ad_text_front_size, DensityUtil.sp2px(getContext(), 15));
        mContentTextSize = (int) array.getDimension(R.styleable.ADTextView_ad_text_content_size, DensityUtil.sp2px(getContext(), 15));
        array.recycle();
    }
