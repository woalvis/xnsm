...
public class ImageUtil {
    ...
    private final static String productUrl = "/sellerListings/%s/product?q=coverImg";
    ...
    public static String getImgUrl(String path){
        ...
        if (path.startsWith("http")||path.startsWith("https")){
            ...
            result = HttpConstant.HOST+"/documents/"+path;
        }
        return result;
    }
    public static String getProductImg(String url){
    ...
    public void showImg(Bitmap bitmap, Context mContext){
        RxDialogScaleView rxDialogScaleView = new RxDialogScaleView(mContext);
        rxDialogScaleView.setImageBitmap(bitmap);
        rxDialogScaleView.show();
    }

    public void showImg(String fileStr, Context mContext){
        RxDialogScaleView rxDialogScaleView = new RxDialogScaleView(mContext);
        rxDialogScaleView.setImagePath(fileStr);
        rxDialogScaleView.show();
    }
